...
- 개발 서비스: 파인핏(키오스크,유저), 헤이미러(스마트미러), 현장통 2.0, 힐링안과, SWalk
...
- 성과 : 회사 주력 제품인 파인핏 개발 및 서비스. 현장통 2.0 DAU 300 ~ 500 달성. SWalk 기기 인증 로직(기기별 RSA 키 발행 및 API 검증) 및 클라이언트 시스템 구조 설계.
